...
class RoughBillLine(models.Model):
    ...
    total_wt = fields.Float(string="Total Wt.", compute="_compute_total_wt", store=True, digits=(16, 4))
    pure = fields.Float(string='Pure', compute="_compute_pure", store=True, digits=(16, 4))
    charges = fields.Float(string='Charges')
    net_weight = fields.Float(compute="_compute_net_weight", store=True, digits=(16, 4))
